...
@section('title', __('admin.payment_admins'))
    ...
    <div class="page-header">
        ...
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>@lang('admin.payment_admins')</span></li>
            </ol>
        </nav>
            ...
            <div class="widget-content widget-content-area br-6">
            	<div class="table-form">
                    <div class="form-group row">
                        ...
                        <a href="{{ route('dashboard.admin.payment_admins.create') }}" class="btn btn-primary">@lang('dashboard.add')</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-6">
                <table class="display table" style="width:100%">
                    ...
                    <tbody>
                    	@foreach ($payment_admins as $index=>$payment)

	                        <tr>
	                            <td>{{ $index+1 }}</td>
	                            <td>{{ $payment->name }}</td>
	                            <td><img src="{{ $payment->image_path }}" width="70"></td>
	                            <td>
                                    <a href="{{ route('dashboard.admin.payment_admins.edit',$payment->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                    ...
                                    <form method="post" action="{{ route('dashboard.admin.payment_admins.destroy', $payment->id) }}" style="display: inline-block;">
                                        @csrf
                                        @method('delete')
