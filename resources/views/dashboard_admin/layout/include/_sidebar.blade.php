...
{{--             <li class="menu {{ request()->segment(3) == 'setting' ? 'active' : '' }}">
                ...
                <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled {{ request()->segment(4) == 'supports' ? 'show' : '' }}" id="payment-admins" data-parent="#accordionExample">
                    <li class="{{ request()->segment(4) == 'support' ? 'active' : '' }}">
                        <a href="{{ route('dashboard.admin.setting.suppors') }}">
                            @lang('admin.supports')
                        </a>
                    </li>
                </ul>
            ...
            <li class="menu {{ request()->segment(3) == 'product_categorys' ? 'active' : '' }}">
                <a href="#product-categorys" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                            <polyline points="9 22 9 12 15 12 15 22"></polyline>
                        </svg>
                        <span>@lang('admin.product_categorys')</span>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                    </div>
                </a>
                <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled {{ request()->segment(3) == 'product_categorys' ? 'show' : '' }}" id="product-categorys" data-parent="#accordionExample">
                    <li class="{{ request()->segment(3) == 'product_categorys' ? 'active' : '' }}">
                        <a href="{{ route('dashboard.admin.product_categorys.create') }}">
                            @lang('dashboard.create') @lang('admin.product_categorys')
                        </a>
                    </li>
                    <li class="{{ request()->segment(3) == 'product_categorys' ? 'active' : '' }}">
                        <a href="{{ route('dashboard.admin.product_categorys.index') }}">
                            @lang('dashboard.list') @lang('admin.product_categorys')
                        </a>
                    </li>
                </ul>
            </li>
