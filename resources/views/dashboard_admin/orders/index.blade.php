            ...
            <div class="widget-content widget-content-area br-6">
            	<div class="table-form">
                    <div class="form-group row">
                        ...
                        <a href="{{ route('dashboard.admin.orders.create') }}" class="btn btn-primary">@lang('dashboard.add')</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="display table" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>@lang('dashboard.groom_name')</th>
                        ...
                        <tbody>
                        	@foreach ($orders as $index=>$order)
    	                        ...
    	                        <tr>
    	                            ...
    	                            <td>
                                        <a href="{{ route('dashboard.admin.orders.edit', $order->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                        ...
                                        <form method="post" action="{{ route('dashboard.admin.orders.destroy', $order->id) }}" style="display: inline-block;">
                                            @csrf
                                            @method('delete')
