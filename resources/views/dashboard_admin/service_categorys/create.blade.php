...
@section('title',  __('dashboard.add') . ' | ' . __('owner.service_categorys'))
        ...
        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <form action="{{ route('dashboard.admin.service_categorys.store') }}" method="POST" class="section general-info">
                            @csrf
                            @method('post')
