            ...
            <div class="widget-content widget-content-area br-6">
            	<div class="table-form">
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <a href="{{ route('dashboard.admin.service_categorys.create') }}" class="btn btn-primary">@lang('dashboard.create')</a>
                        </div>
                    </div>
                </div>{{-- table-form --}}
            </div>{{-- widget-content --}}
                    ...
                    <tbody>
                    	@foreach ($service_categorys as $index=>$categorysy)
	                        ...
	                        <tr>
	                            ...
	                            <td>
                                    <a href="{{ route('dashboard.admin.service_categorys.edit',$categorysy->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                    ...
                                    <form method="post" action="{{ route('dashboard.admin.service_categorys.destroy', $categorysy->id) }}" style="display: inline-block;">
                                        @csrf
                                        @method('delete')
