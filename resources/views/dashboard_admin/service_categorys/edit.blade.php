...
<div class="page-header">
    ...
    <nav class="breadcrumb-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('dashboard.admin.service_categorys.index') }}">@lang('owner.service_categorys')</a></li>
        ...
        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <form action="{{ route('dashboard.admin.service_categorys.update', $serviceCategory->id) }}" method="POST" class="section general-info">
                            @csrf
                            @method('put')
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="qty" class="selectpicker form-control">
                                                                    <option value="false" {{ $serviceCategory->allow_quantity == false ? 'selected' : '' }}>@lang('admin.not_quantity')</option>
                                                                    <option value="true" {{ $serviceCategory->allow_quantity == true ? 'selected' : '' }}>@lang('admin.add_quantity')</option>
                                                            </select>
                                                        </div>
                                                    </div>{{-- col-12 --}}
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="parent_id" class="selectpicker form-control">
                                                                ...
                                                                @foreach ($service_categorys as $categorey)
                                                                    
                                                                    <option value="{{ $categorey->id }}" {{ $categorey->id == $serviceCategory->parent_id ? 'selected' : '' }}>
                                                                        {{ $categorey->name }}
                                                                    </option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="categoreys_id" class="selectpicker form-control">
                                                                ...
                                                                @foreach ($categoreys as $categorey)
                                                                    ...
                                                                    <option value="{{ $categorey->id }}" {{ $categorey->id == $serviceCategory->categoreys_id ? 'selected' : '' }}>
                                                                        {{ $categorey->name }}
                                                                    </option>
