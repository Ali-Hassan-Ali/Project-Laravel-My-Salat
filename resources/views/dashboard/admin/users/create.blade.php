...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item"><a class="back-page" href="{{ route('dashboard.admin.admins.index') }}">@lang('admins.admins')</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('dashboard.admin.admins.store') }}">
                    @csrf
                    @method('post')
