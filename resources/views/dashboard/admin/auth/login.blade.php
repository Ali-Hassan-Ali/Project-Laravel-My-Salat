...
<body>
    ...
    <section class="login-content">
        ...
        <div class="login-box">
            ...
            <form class="login-form" method="POST" action="{{ route('dashboard.admin.login.store') }}">
                <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>SIGN IN</h3>
                    ...
                    <div class="form-group">
                        <div class="utility">
                            <div class="animated-checkbox">
                                <label>
                                    <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}><span class="label-text">@lang('admins.remember_me')</span>
                                </label>
                            </div>
                    ...
                    <div class="form-group btn-container">
                        <button class="btn btn-danger btn-block"><i class="fa fa-sign-in fa-lg fa-fw"></i>@lang('admins.login')</button>
            ...
            <form class="forget-form" action="index.html">
                ...
                {{-- button --}}
                <div class="form-group btn-container">
                    <button class="btn btn-danger btn-block" style="background-color: #dc3545!important"><i class="fa fa-unlock fa-lg fa-fw"></i>RESET</button>
                </div>
