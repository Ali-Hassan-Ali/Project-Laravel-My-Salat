                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name" class="form-control mb-4" placeholder="@lang('dashboard.name')" value="{{ old('name') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label>@lang('owner.form')</label>
                                                            <input type="time" name="form" class="form-control mb-4" placeholder="@lang('owner.form')" value="{{ old('form') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label>@lang('owner.to')</label>
                                                            <input type="time" name="to" class="form-control mb-4" placeholder="@lang('owner.to')" value="{{ old('to') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
