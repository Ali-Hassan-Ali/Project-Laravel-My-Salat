                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name" class="form-control mb-4" placeholder="Full Name" value="{{ $admin->name }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="fullName">Full email</label>
                                                            <input type="email" name="email" class="form-control mb-4" placeholder="enter email" value="{{ $admin->email }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="fullName">phone</label>
                                                            <input type="number" name="phone" class="form-control mb-4" placeholder="enter phone" value="{{ $admin->phone }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
